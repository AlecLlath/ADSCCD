...
L'adresse et le port pour recevoir la connexion en provenance du "password_whisperer" (chuchoteur de mot de passe) et pour se connecter au "vault" (coffre fort) sont listés dans le fichier d'en-tête "socket_conf.h" ou dans le fichier module "socket_conf.py" .
